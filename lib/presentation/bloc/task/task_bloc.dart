...
import 'package:kanban/presentation/repositories/add_task.dart';
import 'package:kanban/presentation/screens/home/entity/text_item.dart';
part 'task_state.dart';

class TaskBloc extends Bloc<TaskEvent, TaskState> {
  final AddTaskRepository taskRepository;
  ...
  TaskBloc(this.taskRepository) : super(TaskInitialState()) {
    on<AddTaskEvent>((event, emit) async {
      ...
      try {
        ...
        String title = "${task.content}!@#${task.id}!@#${task.commentCount}";
